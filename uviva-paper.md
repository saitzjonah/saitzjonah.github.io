...
* The Seeed Studio XIAO ESP32-C3 was chosen as the microcontroller for UViva due to its small size and Wi-Fi capabilities. For interested readers, the ESP32-C3 Series datasheet is linked [here](/assets/uviva/datasheets/esp32-c3_datasheet.pdf).
* The GUVA-S12SD sensor was chosen as the UV sensor for UViva due to its ubiquity and affordability, despite its limited responsivity and precision. The GUVA-S12SD datasheet is linked [here](/assets/uviva/datasheets/1918guva.pdf).
...
* Finally, the wearable device used a standard 3.7V, 1200 mAh lithium-ion polymer battery, the datasheet of which is linked [here](/assets/uviva/datasheets/lipo-datasheet.pdf).
